...
public class DeleteEmployeeAttendance extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfTimeIn.setFocusable(false);

        tfTimeOut.setEditable(false);
        tfTimeOut.setFocusable(false);
        ...
        tfLate.setEditable(false);
        tfLate.setFocusable(false);
        ...
        tfAbsent.setEditable(false);
        tfAbsent.setFocusable(false);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(tfEmpID.getText().isEmpty()) {
            ...
            try {
                ...
                pst = con.prepareStatement("DELETE FROM tbl_attendance WHERE emp_id =?");
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        int rep = JOptionPane.showConfirmDialog(this,"Do you wish to close this form?", "Cancel Delete Attendace Form",JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        switch (rep) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteEmployeeAttendance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class EditEmployeeSalary extends javax.swing.JFrame {
    ...
    public void Connect() {
        try {
            ...
            Logger.getLogger(EditEmployeeSalary.class.getName()).log(Level.SEVERE, null, e);
        } catch (SQLException e) {
            Logger.getLogger(EditEmployeeSalary.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    
    public EditEmployeeSalary() {
        initComponents();
        Connect();
    }
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosing
        int rep = JOptionPane.showConfirmDialog(this,"Do you wish to close this form?", "Cancel Edit Salary Form",JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
        switch (rep) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditEmployeeSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
